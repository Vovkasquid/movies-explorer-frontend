const baseUrl = 'https://api.moviesquid.nomoredomains.monster'
...
const login = (email, password) => fetch(`${baseUrl}/signin`, {
    method: 'POST',
    headers: {
      "Content-Type": "application/json"
    },
...
const editProfile = (name, email) => fetch(`${baseUrl}/users/me`, {
    method: 'PATCH',
    headers: {
      "Content-Type": "application/json",
      authorization: `Bearer ${localStorage.getItem("token")}`,
...
const saveMovies = (movie) => fetch(`${baseUrl}/movies`, {
    method: 'POST',
    headers: {
      "Content-Type": "application/json",
      authorization: `Bearer ${localStorage.getItem("token")}`,
...
const deleteSavedMovies = (id) => fetch(`${baseUrl}/movies/${id}`, {
    method: 'DELETE',
    headers: {
      "Content-Type": "application/json",
      authorization: `Bearer ${localStorage.getItem("token")}`,
